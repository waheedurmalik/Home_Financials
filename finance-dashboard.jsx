...
function ForecastAccountsModal({financials, setFinancials, onClose}) {
  ...
  return React.createElement("div",{style:{position:"fixed",inset:0,background:"rgba(13,15,14,0.96)",zIndex:3000,display:"flex",alignItems:"center",justifyContent:"center",padding:16}},
    React.createElement("div",{style:{background:C.card,border:"1px solid "+C.border,borderRadius:20,maxHeight:"90vh",overflowY:"auto",width:480,maxWidth:"94vw",padding:24}},
...
function HomeTab({transactions, financials, budgets, taxonomy, displayCurrency, dispRates, globalTypeFilter, setTab, setModal, setManageInitSection, setManualInitMode, setManualFromHome, setPositionUnlocked, spikeThreshold, forecastProjection, isWide, drawerOpen, setDrawerOpen}) {
  ...
  return (
    <div style={{padding:isWide?"24px 28px":"16px 12px",maxWidth:1200,margin:"0 auto",boxSizing:"border-box",width:"100%",overflowX:"hidden"}}>
      ...
      <div style={{width:w,flexShrink:0,background:C.surface,borderRight:"1.5px solid "+C.border,
        ...
        <div style={{padding:sidebarCollapsed?"12px 0":"14px 16px 10px",borderBottom:"1px solid "+C.border,
          ...
          <div style={{width:sidebarCollapsed?40:120,height:40,flexShrink:0,background:"transparent",display:"flex",flexDirection:"column",alignItems:sidebarCollapsed?"center":"flex-start"}}>
            {(function(){ var _logoDark=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches; return (
              <img src={_logoDark?"Home_financials_LOGO_Black_Back.png":"Home_financials_LOGO_White_Back.png"} alt="Home Financials" style={{width:sidebarCollapsed?36:120,height:36,objectFit:"contain",display:"block",background:"transparent"}}/>
            ); })()}
            {!sidebarCollapsed&&<div style={{fontSize:9,color:C.dim,fontWeight:600,letterSpacing:"0.06em",marginTop:2}}>hf-v108</div>}
          </div>
        </div>
        {/* Add / Import button */}
        ...
        <div style={{position:"fixed",top:0,left:0,right:0,height:52,
          ...
          <div style={{display:"flex",alignItems:"center",gap:7,padding:"0 10px",flexShrink:0,borderRight:"0.5px solid "+C.border}}>
            <div style={{width:90,height:30,flexShrink:0,background:"transparent",display:"flex",flexDirection:"column",alignItems:"flex-start"}}>
              {(function(){ var _logoDark=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches; return (
                <img src={_logoDark?"Home_financials_LOGO_Black_Back.png":"Home_financials_LOGO_White_Back.png"} alt="Home Financials" style={{width:90,height:28,objectFit:"contain",display:"block",background:"transparent"}}/>
              ); })()}
              <div style={{fontSize:9,color:C.dim,fontWeight:600,letterSpacing:"0.06em"}}>hf-v108</div>
            </div>
          </div>
          {/* Nav items scrolling */}
          ...
          <button onClick={()=>setMobileToolsOpen(v=>!v)}
            style={{flexShrink:0,height:"100%",padding:"0 14px",border:"none",borderLeft:"0.5px solid "+C.border,
                    background:"transparent",cursor:"pointer",fontSize:18,color:C.muted,display:"flex",alignItems:"center",justifyContent:"center"}}>
            ⋮
          </button>
        </div>
        {/* Tools dropdown sheet */}
        {mobileToolsOpen&&(
          <div onClick={()=>setMobileToolsOpen(false)}
            style={{position:"fixed",inset:0,zIndex:200,background:"rgba(0,0,0,0.35)"}}>
            <div onClick={e=>e.stopPropagation()}
              style={{position:"absolute",top:52,right:0,background:C.surface,borderLeft:"1px solid "+C.border,
                      borderBottom:"1px solid "+C.border,borderRadius:"0 0 0 12px",minWidth:200,boxShadow:"0 4px 20px rgba(0,0,0,0.15)"}}>
              <div style={{fontSize:9,fontWeight:800,color:C.dim,letterSpacing:"0.10em",textTransform:"uppercase",padding:"10px 16px 6px"}}>TOOLS</div>
              {TOOLS_NAV.map(function(item,i){
                return (
                  <button key={i} onClick={function(){item.action();setMobileToolsOpen(false);}}
  ...
  return (
    <div style={{minHeight:"100vh",background:C.bg,color:C.text,fontFamily:"inherit",display:"flex",flexDirection:"column",position:"relative"}}>
      ...
      <div style={{display:"flex",flex:1,minHeight:0,height:"100vh",position:"relative"}}>
        ...
        {/* Content area */}
        <div style={{flex:1,minWidth:0,overflowY:"auto",paddingBottom:0,paddingTop:isWide?0:52}}>
                ...
                {tab==="transactions"&&(
                  <div style={card}>
                    ...
                    <div style={{display:"flex",gap:8,marginBottom:8,alignItems:"center",flexWrap:"wrap"}}>
                      ...
                      <button onClick={function(){ if(txCatFilter!==null&&txCatFilter.size===0){setTxCatFilter(null);}else{setTxCatFilter(new Set());} }} style={{padding:"5px 13px",borderRadius:20,border:"1px solid "+(txCatFilter!==null&&txCatFilter.size===0?C.accent:C.border),background:txCatFilter!==null&&txCatFilter.size===0?C.accent:"transparent",color:txCatFilter!==null&&txCatFilter.size===0?"#fff":C.muted,fontSize:12,fontWeight:txCatFilter!==null&&txCatFilter.size===0?700:500,cursor:"pointer",fontFamily:"inherit"}}>Uncategorised</button>
                    </div>
                    <div style={{display:"flex",gap:8,marginBottom:8,alignItems:"center",flexWrap:"wrap"}}>
