...
function ForecastTab({transactions, financials, displayCurrency, displayRates, budgets, setFinancials, taxonomy, onProjectionChange, openModal, setManageInitSection, setManageInitFinancialSub}) {
  ...
  var [showForecastAcctModal, setShowForecastAcctModal] = useState(false);
  ...
  return React.createElement("div",{style:{paddingBottom:40}},
    ...
    // ── Sticky frozen header: toolbar + stat cards ──
    ...
    // Header
    React.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:16,flexWrap:"wrap",gap:8,paddingTop:6}},
      React.createElement("div",null,
      ...
      React.createElement("div",{style:{display:"flex",gap:8,alignItems:"center"}},
        React.createElement("button",{onClick:function(){setShowForecastAcctModal(true);},
    ...
    // D8 — 4 forward-looking closing balance stat cards
    (function(){
      ...
      return React.createElement("div",{style:{display:"flex",gap:10,flexWrap:"wrap",marginBottom:6}},
          ...
          <div style={{padding:isWide?"24px 28px":"16px 14px"}}>
            ...
            {tab!=="home"&&(
              <div>
                ...
                {tab==="forecast"&&(
                  <div style={card}>
                    <ForecastTab transactions={transactions} financials={financials} displayCurrency={displayCurrency} displayRates={displayRates} budgets={budgets} setFinancials={setFinancials} taxonomy={taxonomy} onProjectionChange={setForecastProjection} openModal={openModal} setManageInitSection={setManageInitSection} setManageInitFinancialSub={setManageInitFinancialSub}/>
                  </div>
                )}
