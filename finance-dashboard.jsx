    ...
    return (
      <div style={{width:w,flexShrink:0,background:C.surface,borderRight:"1.5px solid "+C.border,
        ...
        <div style={{padding:sidebarCollapsed?"12px 0":"14px 16px 10px",borderBottom:"1px solid "+C.border,
          ...
          <img src="Home_financials_LOGO_White_Back.png" alt="Home Financials" style={{width:28,height:28,borderRadius:6,objectFit:"cover",flexShrink:0}}/>
          {!sidebarCollapsed&&(
            <div>
              <div style={{fontSize:12,fontWeight:700,color:C.text,whiteSpace:"nowrap"}}>Home Financials</div>
              <div style={{fontSize:9,color:C.dim,fontWeight:600,letterSpacing:"0.06em"}}>hf-v101</div>
            </div>
          )}
        </div>
        {/* Add / Import button */}
  ...
  function renderMobileTopBar() {
    ...
    return (
      <div style={{position:"fixed",top:0,left:0,right:0,height:52,
        ...
        {/* Logo + version */}
        <div style={{display:"flex",alignItems:"center",gap:7,padding:"0 12px",flexShrink:0,borderRight:"0.5px solid "+C.border}}>
      ...
      <div style={{display:"flex",flex:1,minHeight:0,height:"100vh",position:"relative"}}>
        ...
        {!isWide&&(
          <button onClick={()=>setAddSheetOpen(v=>!v)}
            style={{position:"absolute",bottom:20,right:20,width:48,height:48,borderRadius:24,
