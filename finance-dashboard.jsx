                  ...
                  {monthDrill.txDrill.txs.map((tx,i)=>{
                    ...
                    return (
                      <div key={i} style={{padding:"10px 14px",display:"flex",alignItems:"center",gap:10,borderBottom:`1px solid ${C.s2}`}}>
                        ...
                        <div style={{fontFamily:"monospace",fontSize:13,fontWeight:700,color:isCredit?C.accent:C.danger,flexShrink:0}}>{isCredit?"+":"-"}{fmt(tx.amount,currency)}</div>
                      </div>
                    );
                  })}
                </div>
        ...
        <div style={{background:C.bg,border:`1px solid ${C.border}`,borderRadius:12,overflow:"hidden"}}>
          {!items.length?<div style={{padding:28,textAlign:"center",color:C.dim,fontSize:13}}>No transactions</div>:items.map((tx,i)=>(
            <div key={i} style={{padding:"11px 14px",display:"flex",alignItems:"center",gap:10,borderBottom:`1px solid ${C.s2}`}}>
              ...
              <div style={{fontFamily:"monospace",fontSize:13,fontWeight:700,color:tx.isCredit?C.accent:C.danger}}>{tx.isCredit?"+":"−"}{fmt(tx.amount,cur)}</div>
                  ...
                  <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginTop:6}}>
                    <div style={{display:"flex",alignItems:"center",gap:6}}>
                      ...
                      <span style={{fontFamily:"monospace",fontSize:14,fontWeight:800,color:tx.isCredit?C.accent:C.danger}}>
                        {tx.isCredit?"+":"−"}{fmt(tx.amount,currency)}
                      </span>
                    </div>
    ...
    <div style={{paddingBottom:32,maxWidth:isWide?1400:520,margin:"0 auto"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:isWide?"1fr 1fr 1fr 1fr":"1fr 1fr",gap:11,padding:"0 16px",marginBottom:14}}>
        ...
        {Scene({idx:3,height:isWide?220:178,children:[
          CardFront({isWide:isWide,bg:"linear-gradient(140deg,#7a1a5e 0%,#b02880 100%)",section:"Analysis",glyph:<svg viewBox="0 0 110 100" width={isWide?116:82} height={isWide?116:82} xmlns="http://www.w3.org/2000/svg">
              <defs>
              ...
              {/* MONEY BAG — top left */}
              <rect x="12" y="2" width="18" height="8" rx="4" fill="rgba(255,255,255,0.72)"/>
              <ellipse cx="21" cy="13" rx="10" ry="5" fill="rgba(255,255,255,0.82)"/>
              <ellipse cx="21" cy="38" rx="26" ry="28" fill="url(#bagbody)" stroke="rgba(255,255,255,0.4)" strokeWidth="1.5"/>
              <ellipse cx="13" cy="26" rx="9" ry="7" fill="rgba(255,255,255,0.15)"/>
              <text x="21" y="45" textAnchor="middle" fontSize="22" fontWeight="900" fontFamily="Arial,sans-serif" fill="rgba(255,255,255,0.96)">£</text>
              {/* AIRPLANE taking off — top right, rotated */}
              <g transform="translate(54,2) rotate(-26,38,36)">
                <rect x="4" y="30" width="68" height="14" rx="7" fill="rgba(255,255,255,0.92)"/>
                <ellipse cx="74" cy="37" rx="9" ry="7" fill="rgba(255,255,255,0.92)"/>
                <path d="M12,30 L12,14 Q16,10 23,14 L23,30" fill="rgba(255,255,255,0.82)"/>
                <path d="M7,30 L7,23 L20,30" fill="rgba(255,255,255,0.64)"/>
                <path d="M40,44 L6,65 L50,48" fill="rgba(255,255,255,0.75)"/>
                <ellipse cx="22" cy="57" rx="9" ry="4" fill="rgba(255,255,255,0.50)"/>
                <rect x="44" y="34" width="24" height="6" rx="3" fill="rgba(120,20,100,0.28)"/>
              </g>
              {/* SEDAN — bottom left */}
              <g transform="translate(0,62)">
                <rect x="2" y="16" width="50" height="19" rx="5" fill="rgba(255,255,255,0.88)"/>
                <path d="M10,16 Q15,4 28,4 Q40,4 44,16" fill="rgba(255,255,255,0.88)"/>
                <path d="M13,16 Q18,6 28,6 Q38,6 41,16" fill="rgba(120,20,100,0.26)"/>
                <ellipse cx="52" cy="24" rx="4" ry="3" fill="rgba(255,240,160,0.75)"/>
                <rect x="2" y="21" width="3" height="5" rx="1" fill="rgba(255,80,80,0.7)"/>
                <circle cx="12" cy="35" r="8" fill="rgba(255,255,255,0.16)" stroke="rgba(255,255,255,0.88)" strokeWidth="3"/>
                <circle cx="12" cy="35" r="3" fill="rgba(255,255,255,0.55)"/>
                <circle cx="40" cy="35" r="8" fill="rgba(255,255,255,0.16)" stroke="rgba(255,255,255,0.88)" strokeWidth="3"/>
                <circle cx="40" cy="35" r="3" fill="rgba(255,255,255,0.55)"/>
              </g>
              {/* SHOPPING TROLLEY — bottom centre */}
              <g transform="translate(56,62)">
                <path d="M4,4 L1,32 L33,32 L36,4 Z" fill="none" stroke="rgba(255,255,255,0.90)" strokeWidth="3" strokeLinejoin="round"/>
                <line x1="3" y1="16" x2="34" y2="16" stroke="rgba(255,255,255,0.30)" strokeWidth="1.5"/>
                ...
                <circle cx="8" cy="40" r="7" fill="rgba(255,255,255,0.16)" stroke="rgba(255,255,255,0.88)" strokeWidth="3"/>
                <circle cx="8" cy="40" r="2.5" fill="rgba(255,255,255,0.5)"/>
                <circle cx="28" cy="40" r="7" fill="rgba(255,255,255,0.16)" stroke="rgba(255,255,255,0.88)" strokeWidth="3"/>
                <circle cx="28" cy="40" r="2.5" fill="rgba(255,255,255,0.5)"/>
              </g>
              {/* SHOPPING BAG — bottom right */}
              <g transform="translate(76,64)">
                <rect x="0" y="12" width="32" height="28" rx="5" fill="rgba(255,255,255,0.88)"/>
                <path d="M7,12 Q7,2 16,2 Q25,2 25,12" fill="none" stroke="rgba(255,255,255,0.88)" strokeWidth="3" strokeLinecap="round"/>
                <line x1="0" y1="26" x2="32" y2="26" stroke="rgba(120,20,100,0.22)" strokeWidth="2"/>
                <text x="16" y="36" textAnchor="middle" fontSize="13" fontWeight="900" fontFamily="Arial,sans-serif" fill="rgba(120,20,100,0.52)">£</text>
              </g>
          ...
          CardBack({children:[
            ...
            <div style={{display:"flex",gap:5,marginTop:"auto",paddingTop:5}}>
              <div style={{flex:1}}>{GoBtn({onClick:function(){navTo("categories");}, children:"Categories →"})}</div>
              <div style={{flex:1}}>{GoBtn({onClick:function(){navTo("subcategories");}, children:"Subcategories →"})}</div>
            </div>
          ]})
        ]})}
          ...
          : sorted.map(function(t,i){
            ...
            return React.createElement("div",{key:i,
              ...
              React.createElement("span",{style:{fontFamily:"monospace",fontSize:12,fontWeight:700,color:isCredit?G:R,flexShrink:0}},
                (isCredit?"+":"−")+fmt(t.amount,displayCurrency)));
          })),
