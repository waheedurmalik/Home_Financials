        ...
        if(uniqueUnknown.length>0) {
          ...
          try {
            ...
            if(suggestRes.ok){
              ...
              (suggestData.suggestions||[]).forEach(function(s){if(s.description)suggestions[s.description]=s;});
              addLog("✓ Vendor suggestions received for "+Object.keys(suggestions).length+" descriptions");
            }
          } catch(e){ addLog("⚠ Vendor suggestions unavailable — continuing without"); }
        }
