...
// ─── All Subcategories ────────────────────────────────────────────────────────
function AllSubs({transactions,taxonomy,currency,dispRates,onDrill,avgMode,mMonths}) {
...
// ─── Drill-down ───────────────────────────────────────────────────────────────
function Drill({txs,cur,dispRates,taxonomy,onRemap,initCat,initSub,onClearInit,avgMode,mMonths}) {
  ...
  return (
    <div style={card}>
      <div style={{fontFamily:"inherit",fontSize:18,marginBottom:4}}>Spending by Category</div>
      <div style={{fontSize:12,fontWeight:500,color:C.muted,marginBottom:18}}>Tap a category to drill into subcategories and transactions</div>
  ...
  return (
    <div style={{minHeight:"100vh",background:C.bg,color:C.text,fontFamily:"inherit",paddingBottom:90}}>
      ...
      <div style={{maxWidth:tab==="home"?undefined:1100,margin:"0 auto",padding:tab==="home"?"0":"20px 16px"}}>
        ...
        {tab==="categories" && (
          <Drill txs={mTxs} cur={displayCurrency} dispRates={dispRates} taxonomy={taxonomy}
        ...
        {tab==="subcategories" && (
          <AllSubs transactions={mTxs} taxonomy={taxonomy} currency={displayCurrency} dispRates={dispRates}
