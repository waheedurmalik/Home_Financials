        ...
        <div style={{position:"absolute",inset:0,background:"rgba(236,241,235,0.96)",borderRadius:12,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"24px 20px",zIndex:10}}>
          <div style={{width:"100%",maxWidth:380,background:C.surface,borderRadius:14,padding:"22px 20px",boxShadow:"0 4px 24px rgba(0,0,0,0.13)",border:`1px solid ${C.border}`}}>
            ...
            <div style={{textAlign:"center",marginBottom:18}}>
              <a href="https://waheedurmalik.github.io/Home_Financials/privacy-info.html" target="_blank" rel="noreferrer" style={{fontSize:12,color:C.accent,textDecoration:"underline"}}>Further info →</a>
            </div>
            <div style={{display:"flex",gap:10}}>
    ...
    var panel = (
      <div style={panelStyle}>
        <div style={{padding:"6px 16px 10px",borderBottom:"1px solid "+C.border,marginBottom:8}}>
          <div style={{fontSize:9,color:C.dim,fontWeight:600,letterSpacing:"0.06em"}}>hf-v95</div>
        </div>
