    ...
    <div style={{paddingBottom:32,maxWidth:isWide?1400:520,margin:"0 auto"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:isWide?"1fr 1fr 1fr 1fr":"1fr 1fr",gap:11,padding:"0 16px",marginBottom:14}}>
        ...
        {Scene({idx:3,height:isWide?220:178,children:[
          CardFront({isWide:isWide,bg:"linear-gradient(140deg,#7a1a5e 0%,#b02880 100%)",section:"Analysis",glyphSize:isWide?148:116,glyphPb:isWide?34:44,glyph:<svg viewBox="0 0 140 130" width={isWide?148:116} height={isWide?148:116} xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="bagbody" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#3cd882"/>
                  <stop offset="100%" stopColor="#28a064"/>
                </linearGradient>
              </defs>
              {/* MONEY BAG — top left */}
              <rect x="16" y="2" width="22" height="9" rx="4" fill="rgba(255,255,255,0.72)"/>
              <ellipse cx="27" cy="15" rx="12" ry="6" fill="rgba(255,255,255,0.82)"/>
              <ellipse cx="32" cy="46" rx="30" ry="32" fill="url(#bagbody)" stroke="rgba(255,255,255,0.4)" strokeWidth="1.5"/>
              <ellipse cx="20" cy="32" rx="10" ry="8" fill="rgba(255,255,255,0.15)"/>
              <text x="32" y="54" textAnchor="middle" fontSize="26" fontWeight="900" fontFamily="Arial,sans-serif" fill="rgba(255,255,255,0.96)">£</text>
              {/* AIRPLANE — top right, side-view, no rotation */}
              <g transform="translate(72,4)">
                <rect x="0" y="18" width="60" height="12" rx="6" fill="rgba(255,255,255,0.92)"/>
                <ellipse cx="62" cy="24" rx="8" ry="6" fill="rgba(255,255,255,0.92)"/>
                <path d="M8,18 L8,5 Q12,2 18,5 L18,18" fill="rgba(255,255,255,0.82)"/>
                <path d="M4,18 L4,12 L16,18" fill="rgba(255,255,255,0.64)"/>
                <path d="M34,30 L4,46 L40,34" fill="rgba(255,255,255,0.75)"/>
                <rect x="0" y="22" width="4" height="4" rx="1" fill="rgba(255,255,255,0.5)"/>
                <rect x="6" y="22" width="4" height="4" rx="1" fill="rgba(255,255,255,0.5)"/>
              </g>
              {/* SEDAN — bottom left */}
              <g transform="translate(0,80)">
                <rect x="2" y="16" width="58" height="20" rx="5" fill="rgba(255,255,255,0.88)"/>
                <path d="M10,16 Q16,4 32,4 Q46,4 50,16" fill="rgba(255,255,255,0.88)"/>
                <path d="M14,16 Q20,6 32,6 Q44,6 47,16" fill="rgba(120,20,100,0.26)"/>
                <ellipse cx="60" cy="26" rx="4" ry="3" fill="rgba(255,240,160,0.75)"/>
                <rect x="2" y="22" width="3" height="5" rx="1" fill="rgba(255,80,80,0.7)"/>
                <circle cx="14" cy="37" r="8" fill="rgba(255,255,255,0.16)" stroke="rgba(255,255,255,0.88)" strokeWidth="3"/>
                <circle cx="14" cy="37" r="3" fill="rgba(255,255,255,0.55)"/>
                <circle cx="46" cy="37" r="8" fill="rgba(255,255,255,0.16)" stroke="rgba(255,255,255,0.88)" strokeWidth="3"/>
                <circle cx="46" cy="37" r="3" fill="rgba(255,255,255,0.55)"/>
              </g>
              {/* SHOPPING TROLLEY — bottom centre */}
              <g transform="translate(68,80)">
                <path d="M4,4 L1,32 L35,32 L38,4 Z" fill="none" stroke="rgba(255,255,255,0.90)" strokeWidth="3" strokeLinejoin="round"/>
                <line x1="3" y1="16" x2="36" y2="16" stroke="rgba(255,255,255,0.30)" strokeWidth="1.5"/>
                <line x1="0" y1="4" x2="4" y2="4" stroke="rgba(255,255,255,0.88)" strokeWidth="3" strokeLinecap="round"/>
                <path d="M0,4 Q-5,4 -7,0" fill="none" stroke="rgba(255,255,255,0.88)" strokeWidth="3" strokeLinecap="round"/>
                <circle cx="9" cy="42" r="7" fill="rgba(255,255,255,0.16)" stroke="rgba(255,255,255,0.88)" strokeWidth="3"/>
                <circle cx="9" cy="42" r="2.5" fill="rgba(255,255,255,0.5)"/>
                <circle cx="30" cy="42" r="7" fill="rgba(255,255,255,0.16)" stroke="rgba(255,255,255,0.88)" strokeWidth="3"/>
                <circle cx="30" cy="42" r="2.5" fill="rgba(255,255,255,0.5)"/>
              </g>
              {/* SHOPPING BAG — bottom right */}
              <g transform="translate(96,82)">
                <rect x="0" y="12" width="36" height="32" rx="5" fill="rgba(255,255,255,0.88)"/>
                <path d="M7,12 Q7,2 18,2 Q29,2 29,12" fill="none" stroke="rgba(255,255,255,0.88)" strokeWidth="3" strokeLinecap="round"/>
                <line x1="0" y1="28" x2="36" y2="28" stroke="rgba(120,20,100,0.22)" strokeWidth="2"/>
                <text x="18" y="40" textAnchor="middle" fontSize="14" fontWeight="900" fontFamily="Arial,sans-serif" fill="rgba(120,20,100,0.52)">£</text>
              </g>
            </svg>,name:"Income & Spend Analysis",desc:"Categories · subcategories · trends"}),
          CardBack({children:[
            BackHd({children:"This month"}),
        ...
        {Scene({idx:4,height:isWide?220:178,children:[
          CardFront({
            ...
            section:"Transactions",
            glyph:<svg viewBox="0 0 110 104" width={isWide?116:82} height={isWide?116:82} xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="cardgrad" x1="0" y1="1" x2="1" y2="0">
                  <stop offset="0%" stopColor="rgba(255,255,255,0.10)"/>
                  <stop offset="100%" stopColor="rgba(255,255,255,0.28)"/>
                </linearGradient>
                <linearGradient id="chipgrad" x1="0" y1="0" x2="1" y2="1">
                  <stop offset="0%" stopColor="rgba(255,220,80,1)"/>
                  <stop offset="100%" stopColor="rgba(200,155,30,1)"/>
                </linearGradient>
                <clipPath id="cardclip">
                  <rect x="2" y="18" width="106" height="76" rx="10"/>
                </clipPath>
              </defs>
              {/* GHOSTED TRANSACTION ROWS behind card */}
              {[0,1,2,3,4,5,6].map(function(i){
                return <g key={i} transform={"translate(0,"+(i*14)+")"}>
                  <rect x="2" y="4" width="14" height="12" rx="3" fill="rgba(255,255,255,0.07)"/>
                  <rect x="20" y="5" width={44+((i*7)%22)} height="5" rx="2" fill="rgba(255,255,255,0.08)"/>
                  <rect x="20" y="13" width={28+((i*5)%18)} height="3" rx="1.5" fill="rgba(255,255,255,0.05)"/>
                  <rect x="82" y="5" width="24" height="5" rx="2" fill="rgba(255,255,255,0.08)"/>
                  <line x1="2" y1="18" x2="108" y2="18" stroke="rgba(255,255,255,0.04)" strokeWidth="1"/>
                </g>;
              })}
              {/* CARD SHADOW */}
              <rect x="7" y="22" width="106" height="76" rx="11" fill="rgba(0,0,0,0.30)"/>
              {/* CARD BODY */}
              <rect x="2" y="18" width="106" height="76" rx="10" fill="url(#cardgrad)" stroke="rgba(255,255,255,0.50)" strokeWidth="1.5"/>
              {/* SHINE */}
              <path d="M14,22 Q40,17 65,23 Q85,28 96,20" fill="none" stroke="rgba(255,255,255,0.18)" strokeWidth="8" strokeLinecap="round"/>
              {/* MAGNETIC STRIPE */}
              <rect x="2" y="34" width="106" height="20" fill="rgba(0,0,0,0.52)"/>
              {/* CHIP */}
              <rect x="14" y="62" width="26" height="20" rx="4" fill="url(#chipgrad)" stroke="rgba(180,130,20,0.4)" strokeWidth="0.8"/>
              <line x1="14" y1="72" x2="40" y2="72" stroke="rgba(150,100,10,0.45)" strokeWidth="0.8"/>
              <line x1="27" y1="62" x2="27" y2="82" stroke="rgba(150,100,10,0.45)" strokeWidth="0.8"/>
              <rect x="19" y="67" width="16" height="10" rx="2" fill="rgba(200,160,30,0.28)"/>
              {/* CONTACTLESS */}
              <path d="M50,68 Q56,72 50,76" fill="none" stroke="rgba(255,255,255,0.80)" strokeWidth="2.5" strokeLinecap="round"/>
              <path d="M56,63 Q65,72 56,81" fill="none" stroke="rgba(255,255,255,0.65)" strokeWidth="2.5" strokeLinecap="round"/>
              <path d="M62,58 Q74,72 62,86" fill="none" stroke="rgba(255,255,255,0.48)" strokeWidth="2.5" strokeLinecap="round"/>
              {/* CARD NUMBER */}
              <text x="14" y="60" fontFamily="Arial,sans-serif" fontSize="9" fontWeight="700" fill="rgba(255,255,255,0.88)" letterSpacing="1.5">••••  ••••  ••••  1234</text>
              {/* MASTERCARD */}
              <circle cx="86" cy="72" r="13" fill="rgba(235,30,30,0.72)"/>
              <circle cx="100" cy="72" r="13" fill="rgba(255,160,0,0.72)"/>
              {/* CARDHOLDER */}
              <text x="14" y="90" fontFamily="Arial,sans-serif" fontSize="8" fontWeight="700" fill="rgba(255,255,255,0.52)" letterSpacing="0.8">W MALIK</text>
            </svg>,
  ...
  return (
    <div style={{minHeight:"100vh",background:C.bg,color:C.text,fontFamily:"inherit",paddingBottom:90}}>
      ...
      <div style={{maxWidth:tab==="home"?undefined:1100,margin:"0 auto",padding:tab==="home"?"0":"20px 16px"}}>
        ...
        <div style={{marginBottom:16,display:(tab==="home"||tab==="summary"||tab==="position"||tab==="forecast")?"none":"block"}}>
        ...
        <div style={{display:(tab==="home"||tab==="summary"||tab==="position"||tab==="forecast")?"none":"flex",gap:6,alignItems:"center",marginBottom:10}}>
        ...
        <div style={{display:(tab==="home"||tab==="summary"||tab==="position"||tab==="forecast")?"none":"flex",gap:6,marginBottom:10,alignItems:"center"}}>
        ...
        {/* Cost type filter */}
        <div style={{display:(tab==="home"||tab==="summary"||tab==="position"||tab==="forecast")?"none":"flex",gap:6,flexWrap:"wrap",marginBottom:12,alignItems:"center"}}>
          {Object.entries(TYPE_META).map(([v,m])=>(
        ...
        <div style={{display:(tab==="home"||tab==="summary"||tab==="position"||tab==="forecast")?"none":"grid",gridTemplateColumns:"repeat(auto-fit,minmax(150px,1fr))",gap:12,marginBottom:18}}>
          {[
        ...
        {/* Tabs */}
        <div style={{background:C.surface,borderRadius:14,marginBottom:18,border:`1px solid ${C.border}`,boxShadow:"0 1px 3px rgba(0,0,0,0.05)",overflowX:"auto",WebkitOverflowScrolling:"touch",display:(tab==="home"||tab==="summary"||tab==="position"||tab==="forecast")?"none":"block"}}>
