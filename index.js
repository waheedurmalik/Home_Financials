  ...
  try {
    ...
    if (body.images && body.images.length > 0) {
      ...
      parts.push({ text: "Extract all transactions from these bank statement screenshots. " +
        "Return ONLY a JSON array: [{\"date\":\"YYYY-MM-DD\",\"description\":\"merchant\",\"amount\":number,\"isCredit\":boolean}]" });
    ...
    if (useDirectPdf) {
      ...
      const parts = [
        ...
        { text: "Extract all transactions from this bank statement PDF.\n" +
          "Return ONLY a JSON array: [{\"date\":\"YYYY-MM-DD\",\"description\":\"clean merchant name\",\"amount\":number,\"isCredit\":boolean}]\n" +
